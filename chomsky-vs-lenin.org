...
#+DESCRITPTION: A refutation of some leftwing criticisms of Marxism and Leninism
#+AUTHOR: JL & MA
...
#+HTML_HEAD: <style> @media screen and (max-width: 768px) #content {padding: 1.618em 1.5em;}</style>
#+HTML_HEAD: <style>html{scroll-behavior: smooth;}</style>
#+HTML_HEAD: <style>blockquote{background-color:#1c013a3b; color: #bcd2e1c9;}</style>
